    ...
    return (
        <div className="container py-12 md:py-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Link to="/services/mobile-development" className="block h-full">
                    <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer">
                        <CardHeader className="items-center text-center">
                ...
                <Link to="/services/management-software" className="block h-full">
                    <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer">
                        <CardHeader className="items-center text-center">
                ...
                <Link to="/services/hr-software" className="block h-full">
                    <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer">
                        <CardHeader className="items-center text-center">
                ...
                <Link to="/services/whatsapp-automation" className="block h-full">
                    <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer">
                        <CardHeader className="items-center text-center">
                ...
                <Link to="/services/business-automation" className="block h-full">
                    <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer">
                        <CardHeader className="items-center text-center">
